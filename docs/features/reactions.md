...
Двойное касание сообщения ставит быструю реакцию `❤️`, повторное — снимает.
Остальные эмодзи выбираются в меню действий (долгое нажатие или правый клик).
Палитры-кнопки у каждого сообщения больше нет.
