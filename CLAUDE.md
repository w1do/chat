...
- `demo.html` — автономный презентационный лендинг продукта в корне репозитория.
...
- лендинг `demo.html` актуален для затронутой пользовательской функции и не описывает неподтверждённую возможность как доступную;
