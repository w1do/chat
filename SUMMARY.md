...
| chat/rooms-and-messages | Комнаты и членство: миграции (PostgreSQL, единственный owner на уровне БД), политики и матрица ролей (8 package-тестов), команды/запросы с транзакциями и row-lock, V1 endpoints со scoped bindings (9 feature-тестов), OpenAPI+client, RoomList/Membership UI (8 компонентных тестов). Сообщения/реакции — этап 6 | in progress |
