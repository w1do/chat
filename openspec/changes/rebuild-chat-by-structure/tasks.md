...
- [x] 2.6 Add deploy reload flow (`octane:reload`, `horizon:terminate`, `reverb:restart`) to `./tools/chat` and verify `./tools/chat smoke runtime` checks HTTP, queue, and WebSocket readiness against the dev Compose stack
